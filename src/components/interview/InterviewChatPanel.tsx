...
export function InterviewChatPanel({title, subtitle, messages, onSend, disabled, onBack}: Props) {
    return (
        <div
            className="h-full rounded-2xl border border-slate-200/70 bg-white/75 shadow-[0_10px_30px_rgba(11,18,32,0.06)] backdrop-blur overflow-hidden flex flex-col">
