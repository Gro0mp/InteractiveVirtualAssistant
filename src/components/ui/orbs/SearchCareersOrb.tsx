...
export function SearchCareersOrb() {
    return (
        <Link to="/search-jobs">
            ...
            <motion.div
                ...
                <div className="relative w-[100px] h-[100px] sm:w-[400px] sm:h-[400px]">
                    ...
                    <motion.div
                        ...
                        className="absolute inset-0 rounded-full bg-gradient-to-br from-violet-500 via-orange-400 to-orange-500 opacity-20 blur-3xl will-change-transform transform-gpu"/>
